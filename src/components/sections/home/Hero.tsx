...
const DEFAULT_HERO = {
  badge: 'New: Authentic Italian Cuisine',
  title: 'Experience culinary excellence at',
  titleHighlight: 'Bella Vista Restaurant',
  description:
    'Indulge in authentic Italian flavors crafted with the finest ingredients. Our elegant dining experience combines traditional recipes with modern presentation.',
  features: [
